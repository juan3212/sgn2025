    ...
    WithChunkReading
{
    ...
    public function collection(Collection $rows)
    {
        foreach ($rows as $row) {
            if (
                !isset($row["documento_estudiante"]) ||
                !isset($row["nombre_estudiante"])
            ) {
                continue;
            }
    ...
    private function guardarInfoAdicional($usuarioId, $row, $tipoPersona)
    {
        ...
        if (
            ...
            !empty($row["fecha_de_nacimiento_estudiante"])
        ) {
            ...
            if ($existeInfo) {
                DB::table("usuario_informacion")
                    ...
                    ->update([
                        "fecha_nacimiento" =>
                            $row["fecha_de_nacimiento_estudiante"],
