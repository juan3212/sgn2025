                ...
                <div class="w-[80%] mx-auto text-justify space-y-4 text-sm md:text-base leading-relaxed text-black font-sans">
                    ...
                    <div id="padre">
                        <p>
                            ...
                            <span class="font-bold">Y CELULAR</span> <span class="font-bold underline">{{ $fatherPhone }}</span> 
                        </p>
                    </div>
                    ...
                    <div id="madre">
                        <p>
                            ...
                            <span class="font-bold">Y CELULAR</span> <span class="font-bold underline">{{ $motherPhone }}</span> 
                        </p>
                    </div>

                    <div id="parte-b">
                        <p>vecinos de esta ciudad e identificados con los números de Cédula de Ciudadanía como aparecen al pie de sus correspondientes firmas, quien en adelante y para los efectos de este contrato se denominarán los PADRES DE FAMILIA Y/O ACUDIENTES, con obligaciones solidarias, han convenido suscribir el presente CONTRATO DE SERVICIOS EDUCATIVOS, como representantes del </p>
                    </div>
                    ...
                    <div id="parte-fecha">
                        ...
                        <span class="font-bold underline">{{ $day }}</span> días del mes de <span class="font-bold underline">{{ $month }}</span> de <span class="font-bold underline">{{ $year }}</span>
                    </div>
