<div>
   ...
   <livewire:matriculas.components.upload-document tipoDocumento="Documento de identidad" usuario="estudiante" nombreDocumento="documento_identidad" wire:key="documento" :$estudianteId />
    <p wire:click="pruebaGuardado">prueba guardado</p>
</div>
