<div class="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-lg">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div>
            <label for="periodo" class="block text-sm font-medium text-gray-700 mb-2">Periodo</label>
            <select wire:model="periodoSelected" id="periodo" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
